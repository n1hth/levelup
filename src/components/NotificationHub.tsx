      ...
      <AnimatePresence>
        {latestPopup && (
          <motion.div
            ...
            className="fixed top-24 left-5 right-5 z-[200] system-panel bg-blue-600 text-white p-4 shadow-2xl border-blue-400 flex items-center gap-4 cursor-pointer"
